...
_rpesegm = Extension("_rpesegm",
                   ["rpesegm.i", "rpesegm.cpp", "assembly3d.cpp", "ml3d.cpp", "geom.cpp", "raster.cpp", "csv.cpp"],
...
_rpeutil = Extension("_rpeutil",
                   ["rpeutil.i", "rpeutil.cpp", "flatcont.cpp", "comparator.cpp", "geom.cpp", "raster.cpp", "csv.cpp"],
                   include_dirs = [numpy_include],
                   swig_opts = ["-c++"],
                   extra_compile_args = _complile_args,
                   )
