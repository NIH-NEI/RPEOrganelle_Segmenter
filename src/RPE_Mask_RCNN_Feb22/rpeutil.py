...
class Compare3dResult(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    base_cells = property(_rpeutil.Compare3dResult_base_cells_get, _rpeutil.Compare3dResult_base_cells_set)
    cmp_cells = property(_rpeutil.Compare3dResult_cmp_cells_get, _rpeutil.Compare3dResult_cmp_cells_set)
    base_slices = property(_rpeutil.Compare3dResult_base_slices_get, _rpeutil.Compare3dResult_base_slices_set)
    cmp_slices = property(_rpeutil.Compare3dResult_cmp_slices_get, _rpeutil.Compare3dResult_cmp_slices_set)
    f_pos = property(_rpeutil.Compare3dResult_f_pos_get, _rpeutil.Compare3dResult_f_pos_set)
    f_neg = property(_rpeutil.Compare3dResult_f_neg_get, _rpeutil.Compare3dResult_f_neg_set)
    fragm = property(_rpeutil.Compare3dResult_fragm_get, _rpeutil.Compare3dResult_fragm_set)
    fused = property(_rpeutil.Compare3dResult_fused_get, _rpeutil.Compare3dResult_fused_set)
    pct_match = property(_rpeutil.Compare3dResult_pct_match_get, _rpeutil.Compare3dResult_pct_match_set)
    f_pos_3d = property(_rpeutil.Compare3dResult_f_pos_3d_get, _rpeutil.Compare3dResult_f_pos_3d_set)
    f_neg_3d = property(_rpeutil.Compare3dResult_f_neg_3d_get, _rpeutil.Compare3dResult_f_neg_3d_set)
    fragm_3d = property(_rpeutil.Compare3dResult_fragm_3d_get, _rpeutil.Compare3dResult_fragm_3d_set)
    fused_3d = property(_rpeutil.Compare3dResult_fused_3d_get, _rpeutil.Compare3dResult_fused_3d_set)
    pct_match_3d = property(_rpeutil.Compare3dResult_pct_match_3d_get, _rpeutil.Compare3dResult_pct_match_3d_set)

    def __init__(self):
        _rpeutil.Compare3dResult_swiginit(self, _rpeutil.new_Compare3dResult())
    __swig_destroy__ = _rpeutil.delete_Compare3dResult

# Register Compare3dResult in _rpeutil:
_rpeutil.Compare3dResult_swigregister(Compare3dResult)
cvar = _rpeutil.cvar
FIX_BORDERS_DNA = cvar.FIX_BORDERS_DNA
FIX_BORDERS_ACTIN = cvar.FIX_BORDERS_ACTIN


def compare_3d_annotations(w, h, d, base_csv, cmp_csv):
    return _rpeutil.compare_3d_annotations(w, h, d, base_csv, cmp_csv)
