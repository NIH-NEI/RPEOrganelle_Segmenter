...
import skimage
import tifffile
from src.RPE_Mask_RCNN_Feb22.savgol import SavitzkyGolay2D
...
from src.RPE_Mask_RCNN_Feb22.mrcnn.config import Config
from src.RPE_Mask_RCNN_Feb22.mrcnn import model as modellib, utils

from src.RPE_Mask_RCNN_Feb22 import rpesegm, rpeutil
from src.RPE_Mask_RCNN_Feb22.util import slice_area
...
def iter_stacks(data_dir, rpefile, _chname, recurse=False):
    ...
    for rpath in rpefile:
        ...
        # print("rpath", rpath ,fpath, os.path.isdir(fpath))
